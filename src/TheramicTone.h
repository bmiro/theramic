...
#define PIN_OCTAVE_1   7
#define PIN_OCTAVE_2   8
#define PIN_OCTAVE_3   9
#define PIN_OCTAVE_4  10
#define PIN_OCTAVE_5  12
...
#define PIN_SOUND_OUTPUT  11

#define PIN_INSTRUMENT      A0
#define PIN_OCTAVE_SELECTOR A1
#define PIN_BEAT_SELECTOR   A2
#define PIN_BEAT            A3
...
#define MIN_OCTAVE OCTAVE_1
#define MAX_OCTAVE OCTAVE_5

#define BEAT_TH 200

/* analogRead < BEAT_NEVER_TH  */
#define BEAT_NEVER_TH 127
#define BEAT_NEVER 0
/* analogRead > BEAT_ALWAYS_TH  */
#define BEAT_ALWAYS_TH 895
#define BEAT_ALWAYS 600
#define BEAT_ALWAYS_DELAY 100 /* 0.1 seconds */
...
class TheramicTone {
  ...
  private:
// If you uncoment this remenger to chenge OCTAVE_COUNT and NOTE_COUNT Values
...
//  */
  ...
  /*       DO       RE       MI       FA      SOL       LA       SI */
    ...
    int _note_leds [NOTE_COUNT];
    int _octave_leds [OCTAVE_COUNT];
    int _current_note;
    int _current_octave;
